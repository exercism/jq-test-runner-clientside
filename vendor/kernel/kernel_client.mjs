...
const SCHEMAS = {
  FsEvent: { kind: "enum", variants: [["FileChanged", { kind: "newtype", inner: { kind: "seq", inner: "u8" } }], ["DirectoryChanged", { kind: "newtype", inner: { kind: "enum", variants: [["Replace", { kind: "struct", fields: [["values", { kind: "seq", inner: { kind: "ref", name: "Entry" } }]] }], ["InsertAt", { kind: "struct", fields: [["index", "u32"], ["value", { kind: "ref", name: "Entry" }]] }], ["UpdateAt", { kind: "struct", fields: [["index", "u32"], ["value", { kind: "ref", name: "Entry" }]] }], ["RemoveAt", { kind: "struct", fields: [["index", "u32"]] }], ["Move", { kind: "struct", fields: [["old_index", "u32"], ["new_index", "u32"]] }], ["Push", { kind: "struct", fields: [["value", { kind: "ref", name: "Entry" }]] }], ["Pop", { kind: "struct", fields: [] }], ["Clear", { kind: "struct", fields: [] }]] } }], ["Error", { kind: "newtype", inner: "string" }]] },
  Entry: { kind: "struct", fields: [["name", "string"], ["kind", { kind: "ref", name: "Kind" }]] },
  Kind: { kind: "enum", variants: [["File", "unit"], ["Directory", "unit"], ["Symlink", { kind: "struct", fields: [["is_directory", "bool"]] }]] },
  Licence: { kind: "struct", fields: [["hostname", "string"], ["signature", "string"]] },
  ProcessEvent: { kind: "enum", variants: [["SessionStarted", { kind: "struct", fields: [["sid", "i32"], ["stream_id", "u32"], ["piped", "bool"], ["argv", { kind: "seq", inner: "string" }]] }], ["ProcessStarted", { kind: "struct", fields: [["sid", "i32"], ["pid", "i32"], ["parent_pid", "i32"], ["pgid", "i32"], ["argv", { kind: "seq", inner: "string" }]] }], ["ProcessExecd", { kind: "struct", fields: [["sid", "i32"], ["pid", "i32"], ["argv", { kind: "seq", inner: "string" }]] }], ["ProcessExited", { kind: "struct", fields: [["sid", "i32"], ["pid", "i32"], ["result", { kind: "enum", variants: [["Ok", { kind: "newtype", inner: { kind: "option", inner: "i32" } }], ["Err", { kind: "newtype", inner: "string" }]] }]] }], ["SessionEnded", { kind: "struct", fields: [["sid", "i32"], ["result", { kind: "enum", variants: [["Ok", { kind: "newtype", inner: { kind: "option", inner: "i32" } }], ["Err", { kind: "newtype", inner: "string" }]] }]] }]] },
};

const METHODS = [
  { name: "resizeTty", kind: "notify", args: [{ kind: "postcard", schema: "u32" }, { kind: "postcard", schema: "u16" }, { kind: "postcard", schema: "u16" }], returns: null },
  { name: "writeFile", kind: "notify", args: [{ kind: "inline", schema: "string" }, { kind: "js", transfer: true }], returns: null },
  { name: "readFile", kind: "value", args: [{ kind: "inline", schema: "string" }], returns: { kind: "result", ok: { kind: "js", transfer: true }, err: { kind: "postcard", schema: "string" } } },
  { name: "fsEvents", kind: "stream", args: [{ kind: "inline", schema: "string" }], returns: { kind: "postcard", schema: { kind: "ref", name: "FsEvent" } } },
  { name: "boot", kind: "value", args: [{ kind: "inline", schema: "string" }, { kind: "postcard", schema: { kind: "seq", inner: "string" } }, { kind: "postcard", schema: { kind: "seq", inner: "string" } }, { kind: "option", inner: { kind: "postcard", schema: { kind: "seq", inner: { kind: "ref", name: "Licence" } } } }], returns: { kind: "result", ok: { kind: "postcard", schema: "unit" }, err: { kind: "postcard", schema: "string" } } },
  { name: "untar", kind: "value", args: [{ kind: "inline", schema: "string" }, { kind: "js", transfer: true }], returns: { kind: "result", ok: { kind: "postcard", schema: "unit" }, err: { kind: "postcard", schema: "string" } } },
  { name: "tar", kind: "value", args: [{ kind: "postcard", schema: { kind: "seq", inner: "string" } }], returns: { kind: "result", ok: { kind: "js", transfer: true }, err: { kind: "postcard", schema: "string" } } },
  { name: "run", kind: "value", args: [{ kind: "postcard", schema: { kind: "seq", inner: "string" } }, { kind: "postcard", schema: { kind: "seq", inner: "string" } }, { kind: "postcard", schema: "string" }, { kind: "postcard", schema: "bool" }], returns: { kind: "result", ok: { kind: "postcard", schema: "i32" }, err: { kind: "postcard", schema: "string" } } },
  { name: "hangup", kind: "notify", args: [{ kind: "postcard", schema: "i32" }], returns: null },
  { name: "processEvents", kind: "stream", args: [], returns: { kind: "postcard", schema: { kind: "ref", name: "ProcessEvent" } } },
];

const HANDLERS = [
  { name: "streamOut", kind: "value", args: [{ kind: "postcard", schema: "u32" }, { kind: "js", transfer: true }], returns: { kind: "result", ok: { kind: "postcard", schema: "unit" }, err: { kind: "postcard", schema: "string" } } },
  { name: "streamErr", kind: "value", args: [{ kind: "postcard", schema: "u32" }, { kind: "js", transfer: true }], returns: { kind: "result", ok: { kind: "postcard", schema: "unit" }, err: { kind: "postcard", schema: "string" } } },
  { name: "streamIn", kind: "value", args: [{ kind: "postcard", schema: "u32" }], returns: { kind: "option", inner: { kind: "js", transfer: true } } },
  { name: "streamClosed", kind: "notify", args: [{ kind: "postcard", schema: "u32" }], returns: null },
];

export class KernelClient extends Endpoint {
  constructor(options) {
    super(options, "KernelClient", new Codec(SCHEMAS), METHODS, HANDLERS);
  }
  resizeTty(ttyId, cols, rows) {
    this._notify(0, [ttyId, cols, rows]);
  }
  writeFile(path, data) {
    this._notify(1, [path, data]);
  }
  readFile(path) {
    return this._request(2, [path]);
  }
  fsEvents(path, callback) {
    return this._stream(3, [path], callback);
  }
  boot(sysroot, env, preload, licence) {
    return this._request(4, [sysroot, env, preload, licence]);
  }
  untar(path, data) {
    return this._request(5, [path, data]);
  }
  tar(paths) {
    return this._request(6, [paths]);
  }
  run(argv, env, cwd, piped) {
    return this._request(7, [argv, env, cwd, piped]);
  }
  hangup(sid) {
    this._notify(8, [sid]);
  }
  processEvents(callback) {
    return this._stream(9, [], callback);
  }
}
